...
func Run(apiKey string, apiEmail string, baseDomain string, domainsToCheck []string, serviceLevels []string, forceUpdate bool) {
	...
	updateCloudFlare(apiKey, apiEmail, currentIP, baseDomain, domainsToCheck, serviceLevels)
}
...
func updateCloudFlare(apiKey string, apiEmail string, currentIP string, baseDomain string, domainsToCheck []string, serviceLevels []string) {
